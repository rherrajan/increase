...
public class UpdateService implements IncreaseLocationListener {
	...
	public UpdateService(Context context, Class<?> alarmReciver){
		this.notificationService = new NotificationService(context);
		this.locationService = new LocationService(context);
		this.alarmService = new AlarmService(context);
		this.context = context;

		this.notificationService.setActivityToNotificate(context.getClass());
		this.alarmService.setActivityToNotificate(alarmReciver);
	}
